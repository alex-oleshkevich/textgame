...
class StateProvider extends Component<StateContextProps, StateContextState> {
    ...
    handleWheel = event => {
        ...
        if (this.isDown || disabled || this.stateProvider.options.disabled || !wrapperComponent || !contentComponent)
            return;
    ...
    setTransform = (newPosX, newPosY, newScale, speed = 200, type = 'easeOut') => {
        const {
            positionX,
            positionY,
            scale,
