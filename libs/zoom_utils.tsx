...
export function wheelMousePosition(event, contentComponent, scale): { mouseX: number; mouseY: number } {
...
export function handleCalculatePositions(mouseX, mouseY, newScale, bounds, limitToBounds) {
    ...
    const newPositions = checkPositionBounds(calculatedPositionX, calculatedPositionY, bounds, limitToBounds, 0, null);
